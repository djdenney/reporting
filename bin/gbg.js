...
async function buildReport() {
    ...
    try {
        ...
        row = ["BOPIS Orders Store 1d", "Processing", "N[97] time to take BOPIS to get to store", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = bpt7
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["BOPIS Orders Store 7d", "Processing", "N[97] time to take BOPIS to get to store", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = can1
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Daily Cancellation 1d", "Cancellation", "Total Cancellation Rate 1d", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = can7
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Daily Cancellation 7d", "Cancellation", "Total Cancellation Rate 7d", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = svdc1
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Daily Cancellation", "Cancellation", "% Of Order Cancellations Sourcing from Fulfillment", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = acr
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Cancellation", "Cancellation", `All Cancel Rates`, `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = ctsov
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Cancellation", "Cancellation", `% of Cancels to Store or Vendor`, `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = coct
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Critical Tickets", "DevOps", "No Open Critical Tickets", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = ctc
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Critical Tickets", "DevOps", "Critical Tickets in Last 24 Hours", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = bs.BACKORDERED
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Allocated vs. Released", "Processing", "% of orders placed in last day that have been placed in Backorder", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = bs.SUCCESSFUL
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Allocated vs. Released", "Processing", "Orders placed in last day that have released to fulfillment 97% (exceptions include, hold, remorse)", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = sia
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Allocated vs. Released", "Processing", "Orders stuck in allocated that are not on hold- Should be nothing that doesn't start in Order ID or CIT or it should be aged less than an hour", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = ttr.ITS
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Allocated vs. Released", "Processing", "N[97] Avg. Time to Release by Brand: ITS", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = ttr.LEA
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Allocated vs. Released", "Processing", "N[97] Avg. Time to Release by Brand: LEA", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = ttr.LPS
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Allocated vs. Released", "Processing", "N[97] Avg. Time to Release by Brand: LPS", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = ttr.PSW
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Allocated vs. Released", "Processing", "N[97] Avg. Time to Release by Brand: PSW", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = ttr.PRO
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Allocated vs. Released", "Processing", "N[97] Avg. Time to Release by Brand: PRO", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = ttr.MP
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Allocated vs. Released", "Processing", "N[97] Avg. Time to Release by Brand: MP", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = odbxmp
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Returns (Blind), Rate, Age", "Returns", `Blind Returns - 1d (Non-Marketplace)`, `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = owbxmp
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Returns (Blind), Rate, Age", "Returns", `Blind Returns - 7d (Non-Marketplace)`, `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = odbmp
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Returns (Blind), Rate, Age", "Returns", `Blind Returns - 1d (Marketplace)`, `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        oprat.forEach((line) => {
            ...
            switch(Object.keys(line)[0]) {
                ...
                case "ThirtyDayOpenDC3PLStore":
                    ...
                    sla = 5
                    tar = 2.5
                    met = "% open on DC's, 3PL's and Stores on 30 day"
                    break;
                case "OpenThirtyDays":
                    console.log(`Orders Open 30 Days: ${Object.values(line)[0]}`);
                    sla = 300
                    tar = 150
                    met = "# open orders > 30 days"
                    typ = ""
                    break;
                case "VendorThirtyDayRate":
                    ...
                    sla = 10
                    tar = 5
                    met = "Vendors should be under 5% on open orders on 30 day"
                    break;
                case "VendorSevenDayRate":
                    console.log(`Orders Open 7 Days Rate for Vendor: ${Object.values(line)[0]}%`);
                    sla = 20
                    tar = 10
                    met = "Vendors should be under 20% on 7 day"
                    break;
                case "OneDayTotal":
        ...
        act = rts
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Order Aging", "Fulfillment", "Return to Pick Shelf", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = sps
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Order Aging", "Fulfillment", "Orders Stale in Pick Status", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = odusfrvsfr
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Bounce Report", "Store Performance", "Store Unique Fill Rate vs. Store fill Rate should be within 10%", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = sbr
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Bounce Report", "Store Performance", "Store Bounce Rate", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        typ = ""
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Bounce Report", "Store Performance", "# Open Orders that have bounced to stores more than 10 times should be less than 100", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = utb
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Bounce Report", "Store Performance", "# Open orders that have bounced to stores more than 10 times to unique store should be under 5", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        typ = "%"
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Bounce Report", "Store Performance", "Vendor Fill Rate and Unique fill rate should be within 5", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        act = vbr
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Bounce Report", "Store Performance", "Vendor bounce rate", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        typ = ""
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Bounce Report", "Store Performance", "# Open Orders that have bounced to vendors more than 10 times should be less than 25", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
        ...
        typ = "%"
        oper[ind](act, tar) ? res = "Exceeds SLA" : oper[ind](act, sla) ? res = "Meets SLA" : res = "Fails to meet SLA"
        row = ["Bounce Report", "Store Performance", "BOPIS Cancellation Rate under 7% (combine cancellations and shorts)", `${ind} ${sla}${typ}`, `${ind} ${tar}${typ}`, `${act}${typ}`, res,  ""]
        rows.push(row)
        //
